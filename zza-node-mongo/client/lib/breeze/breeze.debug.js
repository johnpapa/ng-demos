...
breeze.makeComplexArray = (function() {
    ...
    complexTypes associated with a data property on a single entity or other complex object. i.e. customer.order or order.orderDetails.
...
breeze.makeRelationArray = (function() {
    ...
    entities associated with a navigation property on a single entity. i.e. customer.order or order.orderDetails.
    This collection looks like an array in that the basic methods on arrays such as 'push', 'pop', 'shift', 'unshift', 'splice'
    are all provided as well as several special purpose methods.
    ...
    **/
    ...
    @example
        // assume order is an empty, as yet unpopulated, relation array of order
...
var EntityQuery = (function () {
    ...
    **/
    ...
    /**
    Returns a new query that order the results of the query by property name.  By default sorting occurs is ascending order, but sorting in descending order is supported as well.
    @example
            var query = new EntityQuery("Customers")
                .orderBy("CompanyName");
    ...
    **/
    ...
    /**
    Returns a new query that order the results of the query by property name in descending order.
    @example
            var query = new EntityQuery("Customers")
    ...
    **/
    ...
    @example
        ...
        var query = new EntityQuery("Orders").using(em);
        var order = query.executeLocally();
...
var EntityManager = (function () {
    ...
    **/
    ...
    @example
            var em = new EntityManager(serviceName);
            var query = new EntityQuery("Orders");
            var order = em.executeQueryLocally(query);
